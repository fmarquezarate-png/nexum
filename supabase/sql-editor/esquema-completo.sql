...
-- ═══════════════════════════════════════════════════════════════════════
--
--  Todas las migraciones unidas, para crear la base de datos DESDE CERO.
--  Si tu proyecto ya tiene tablas, usa el archivo incremental que toque.
--  Se GENERA a partir de supabase/migrations/. No editar a mano.
--
